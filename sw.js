const CACHE='driverseat-workout-v23';
...
self.addEventListener('fetch',e=>{
  ...
  if(r.mode==='navigate'){
    e.respondWith((async()=>{
      ...
      if(!html.includes('warmup-cardio.js'))html=html.replace('</body>','<script src="warmup-cardio.js?v=23"></script></body>');
  ...
  if(u.pathname.endsWith('/demo-links.js')||u.pathname.endsWith('/warmup-cardio.js')){
